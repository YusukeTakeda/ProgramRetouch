...
//			String selectedDeliveryMethodName = (request.getParameter("delivery_method_name"));
//			int selectedDeliveryFee = Integer.parseInt(request.getParameter("delivery_method_price"));
