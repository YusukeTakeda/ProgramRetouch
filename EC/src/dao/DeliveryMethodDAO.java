...
public class DeliveryMethodDAO {
     ...
     * @throws SQLException
     */
	public static DeliveryMethodDataBeans getDeliveryMethodDataBeansByBuyId(int buyId, String deliveryMethodName, int deliveryMethodPrice) throws SQLException {
		Connection con = null;
		PreparedStatement st = null;
		try {
			con = DBManager.getConnection();
